...
public static class G_PropertyDrawerUtility
{
    ...
    public static void HelpBox(Rect pos, string message, MessageType type, string manualURL = null)
    {
        ...
        // draw text box
        GUI.TextArea(pos, message, ((type != MessageType.None) ? G_PropertyDrawerUtility.HelpboxIconTextBoxStyle : G_PropertyDrawerUtility.HelpboxTextBoxStyle));

        // draw icon
        GUIStyle m_HelpboxIconStyle = null;
        switch (type)
        {
            case MessageType.Error: m_HelpboxIconStyle = G_PropertyDrawerUtility.HelpboxErrorIconStyle; break;
            case MessageType.Info: m_HelpboxIconStyle = G_PropertyDrawerUtility.HelpboxInfoIconStyle; break;
            case MessageType.Warning: m_HelpboxIconStyle = G_PropertyDrawerUtility.HelpboxWarningIconStyle; break;
            case MessageType.None: m_HelpboxIconStyle = G_PropertyDrawerUtility.HelpboxNoIconStyle; break;
        }
